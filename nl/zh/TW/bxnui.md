...
## BXNUI2068E
**訊息**：由於偵測到空值 URL 值，因此未載入服務 ID "{0}" 的遠端 URL。

請前往 [{{site.data.keyword.Bluemix_notm}} 支援中心 ![外部鏈結圖示](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}。

## BXNUI2069E
**訊息**：由於發生錯誤："{1}"，因此未載入服務 ID "{2}" 的 URL "{0}"。
...
## BXNUI2090E
**訊息**：嘗試在下列 URL 登錄範本失敗："{0}"。範本內容的格式錯誤。錯誤："{1}"
...
您必須是組織 "{1}"（JSON 輸入檔中針對 owningOrganization 所指定的組織）中的組織管理員，才能建立或更新此服務分配管理系統。  
...
請登出、重新登入，然後再試一次。如果問題持續發生，請前往 [{{site.data.keyword.Bluemix_notm}} 支援中心 ![外部鏈結圖示](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}。

## BXNUI3016E
**訊息**：容器不存在。可能已被刪除。

請檢查，然後再試一次。如果問題持續發生，請前往 [{{site.data.keyword.Bluemix_notm}} 支援中心 ![外部鏈結圖示](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}。
...
請重試。如果再次看到此訊息，請與 [{{site.data.keyword.Bluemix_notm}} 支援中心 ![外部鏈結圖示](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window} 聯絡。
