...
如果您有一个有效的 {{site.data.keyword.Bluemix_notm}} 帐户，那么可以使用以下步骤在支持中心开具支持凭单：
  1. 在菜单栏中，单击**支持** > **支持中心**。
