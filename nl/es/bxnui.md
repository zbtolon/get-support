...
Para obtener instrucciones para solucionar este problema, consulte el tema de resolución de problemas [La página de {{site.data.keyword.Bluemix_notm}} no se puede cargar](https://www.{DomainName}/docs/troubleshoot/ts_accessing.html#ts_err){: new_window}.
...
Para obtener instrucciones para solucionar este problema, consulte [La página de {{site.data.keyword.Bluemix_notm}} no se puede cargar](https://www.{DomainName}/docs/troubleshoot/ts_accessing.html#ts_err){: new_window}.
...
Para obtener detalles, consulte los [Requisitos previos](https://www.{DomainName}/docs/overview/prereqs.html#browsers){: new_window}.
...
Vuelva a intentarlo más tarde. Si el problema continúa, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}} ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo")](http://ibm.biz/bluemixsupport){: new_window}.
...
Para obtener instrucciones para solucionar este problema, consulte el tema de resolución de problemas [La cuenta está inactiva](https://www.{DomainName}/docs/troubleshoot/ts_accounts.html#ts_accnt_inactive){: new_window}.

## BXNUI0097E
**Mensaje**: Para poder añadir una app, al menos un espacio debe estar asociado con la organización y la región.

En el Panel de control, pulse **Crear un espacio**. Cuando se cree el espacio, vuélvalo a intentar. Para obtener instrucciones para solucionar este problema,

consulte el tema de resolución de problemas [No hay espacio asociado a la organización actual](https://www.{DomainName}/docs/troubleshoot/ts_accounts.html#ts_no_space){: new_window}.
...
Intente utilizar un nombre distinto o vuelva a intentarlo más tarde. Si el problema continúa, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}} ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo")](http://ibm.biz/bluemixsupport){: new_window}.
...
Vuelva al panel de control e inténtelo de nuevo. Si el problema continúa, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}} ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo")](http://ibm.biz/bluemixsupport){: new_window}.
...
Intente volver a revocar el acceso. Si el problema continúa, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}} ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo")](http://ibm.biz/bluemixsupport){: new_window}.
...
Para resolver este problema, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}} ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo")](http://ibm.biz/bluemixsupport){: new_window}.
...
Inténtelo de nuevo más tarde o vaya a [Soporte de {{site.data.keyword.Bluemix_notm}} ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo")](http://ibm.biz/bluemixsupport){: new_window}.
...
Vuelva a intentarlo más tarde. Si vuelve a ver este mensaje, vaya a la [página de estado de {{site.data.keyword.Bluemix_notm}} ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo")](https://developer.ibm.com/bluemix/support/#status){: new_window} para comprobar si el servicio o el componente tiene algún problema. O bien, para obtener instrucciones para solucionar este problema, consulte el tema de resolución de problemas [No se pueden recuperar espacios en la organización](https://www.{DomainName}/docs/apps/ts_apps.html#ts_retrieve_space){: new_window}.
...
Vuelva a intentarlo más tarde. Si vuelve a ver este mensaje, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}} ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo")](http://ibm.biz/bluemixsupport){: new_window}.
...
Inténtelo de nuevo. Si el problema continúa, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}} ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo")](http://ibm.biz/bluemixsupport){: new_window}.
...
Para obtener instrucciones para solucionar este problema, consulte el tema de resolución de problemas [El límite de servicios de la organización se ha excedido](https://www.{DomainName}/docs/apps/ts_apps.html#ts_servicelimit){: new_window}.
...
Si el problema continúa, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}} ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo")](http://ibm.biz/bluemixsupport){: new_window}.
...
Para obtener detalles sobre el número de certificados permitidos y cómo suprimirlos o sustituirlos, consulte el tema [Carga de certificados SSL](https://www.{DomainName}/docs/apps/secapps.html#ssl_certificate){: new_window}.
...
Cierre la sesión, inicie la sesión de nuevo y vuélvalo a intentar.  Si el problema continúa, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}} ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo")](http://ibm.biz/bluemixsupport){: new_window}.
...
Inténtelo de nuevo. Si vuelve a ver este mensaje, póngase en contacto con el [Soporte de {{site.data.keyword.Bluemix_notm}} ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo")](http://ibm.biz/bluemixsupport){: new_window}.
