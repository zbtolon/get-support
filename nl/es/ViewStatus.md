...
* Pulse **Estado** para ver el estado actual de los recursos de todas las ubicaciones de {{site.data.keyword.Bluemix_notm}}. Solo se muestran los sucesos activos.  
...
* Pulse **Historial** para ver una lista de sucesos completados de los últimos 30 días. 
