...
Para obter instruções sobre como corrigir esse problema, consulte o tópico de resolução de problemas [Por que encontro páginas do console que não são carregadas?](/docs/account?topic=account-accessing#accessing){: new_window} .
...
Para obter instruções para corrigir esse problema, consulte [Por que encontro páginas do console que não são carregadas?](/docs/account?topic=account-accessing#accessing){: new_window}
...
Para obter detalhes, consulte [Pré-requisitos](/docs/overview?topic=overview-prereqs-platform#prereqs){: new_window}.
...
Tente novamente mais tarde. Se o problema continuar, acesse [Suporte do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}.
...
Para obter instruções para corrigir esse problema, consulte o tópico de resolução de problemas [A conta está inativa](/docs/account?topic=account-managingaccounts#managingaccounts){: new_window}.
...
Tente usar um nome diferente ou tente novamente mais tarde. Se o problema continuar, acesse [Suporte do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}.
...
Retorne para a lista de recursos e tente novamente. Se o problema continuar, acesse [Suporte do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}.
...
Tente revogar o acesso novamente. Se o problema continuar, acesse [Suporte do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}.
...
Você será desconectado do {{site.data.keyword.Bluemix_notm}} .
...
Para resolver esse problema, acesse [Suporte do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}.
...
Se você vir essa mensagem novamente, acesse a [{{site.data.keyword.Bluemix_notm}} página de status ![Ícone de link externo](../icons/launch-glyph.svg "Ícone de link externo")](https://cloud.ibm.com/status?selected=status){: new_window} para verificar se um serviço ou componente tem um problema. Se o problema continuar, acesse [Suporte do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}.
...
Tente novamente mais tarde ou acesse [Suporte do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}.
...
Sua função de usuário não tem a autoridade necessária nesse espaço ou você não é um membro do espaço.

Caso você seja um membro do espaço, deve-se ter a função de usuário do desenvolvedor para criar instâncias de contêiner. É possível solicitar essa função ao gerenciador da organização. Se você não for um membro desse espaço, será possível solicitar que seja incluído nele.
...
**Mensagem**: os espaços na organização não foram recuperados. Ocorreu um problema de conexão de rede ou sua organização atual não tem um espaço associado a ela.

Tente novamente mais tarde. Se você vir essa mensagem novamente, acesse a [{{site.data.keyword.Bluemix_notm}} página de status ![Ícone de link externo](../icons/launch-glyph.svg "Ícone de link externo")](https://cloud.ibm.com/status?selected=status){: new_window} para verificar se um serviço ou componente tem um problema. Ou para obter instruções para corrigir esse problema, consulte o tópico de resolução de problemas [Não é possível recuperar espaços na organização](/docs/apps/tutorials?topic=creating-apps-managingapps#managingapps){: new_window}.
...
**Mensagem**: os recursos de infraestrutura clássica não foram recuperados, pois ocorreu um problema ao entrar em contato com o SoftLayer.
...
Tente novamente mais tarde. Se você vir essa mensagem novamente, acesse [Suporte do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}.
...
Tente novamente. Se o problema continuar, acesse [Suporte do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}.
...
## BXNUI2024E
**Mensagem**: o autorregistro para usuários não está ativado.
...
Para obter instruções para corrigir esse problema, consulte o tópico de resolução de problemas [O limite de serviços da organização foi excedido](/docs/apps/tutorials?topic=creating-apps-managingapps#ts_servicelimit){: new_window}.
...
Certifique-se de que a organização esteja especificada corretamente. Se você vir essa mensagem novamente, acesse a [{{site.data.keyword.Bluemix_notm}} página de status ![Ícone de link externo](../icons/launch-glyph.svg "Ícone de link externo")](https://cloud.ibm.com/status?selected=status){: new_window} para verificar se um serviço ou componente tem um problema. Se o problema continuar, acesse [Suporte do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}.
...
Se o problema continuar, acesse [Suporte do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}.
...
[Suporte do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}.
...
O nome do domínio, {0}, especificado no certificado não corresponde ao seu nome do domínio customizado.
...
## BXNUI2074E
**Mensagem**: a chave privada não é suportada. Uma chave RSA decriptografada é esperada.
...
## BXNUI2080E
**Mensagem**: a operação que atingiu o tempo limite enquanto certificados e chaves eram modificados.
...
Efetue logout, efetue login novamente e tente outra vez. Se você vir essa mensagem novamente, acesse a [{{site.data.keyword.Bluemix_notm}} página de status ![Ícone de link externo](../icons/launch-glyph.svg "Ícone de link externo")](https://cloud.ibm.com/status?selected=status){: new_window} para verificar se um serviço ou componente tem um problema. Se o problema continuar, acesse [Suporte do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}.
...
Efetue logout, efetue login novamente e tente outra vez.  Se o problema continuar, acesse [Suporte do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}.

## BXNUI3016E
**Mensagem**: o contêiner não existe. Ele pode ter sido excluído.

Verifique e tente novamente.  Se o problema continuar, acesse [Suporte do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}.
...
Tente novamente. Se você vir essa mensagem novamente, entre em contato com o [Suporte do {{site.data.keyword.Bluemix_notm}} ![Ícone de link externo](../icons/launch-glyph.svg)](https://{DomainName}/unifiedsupport/supportcenter){: new_window}.
