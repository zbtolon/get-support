...
A tabela a seguir lista alguns exemplos comuns de problemas de suporte, níveis de segurança sugeridos e os objetivos de tempo de resposta inicial. Os objetivos de tempo de resposta inicial são usados para descrever objetivos da IBM somente e não representam uma garantia de desempenho.

| Severidade | Definição de Severidade | Objetivos de tempo de resposta inicial |
|-----|------- | ----- |
...
{: caption="Tabela 1. Definição de severidade e tempo de resposta inicial" caption-side="top"}
