...
サポート Case が適切に対処されていないと感じる場合や、重大な問題を表面化させたい場合に、エスカレーション・プロセスを使用できます。 Case がエスカレートされると、当番の管理者がそのサポート Case 内の情報を検討し、{{site.data.keyword.Bluemix_notm}} サポート・テクニカル・チームの適切なメンバーを手配し、適切な更新をお客様に提供します。

任意の有料サブスクリプションを持つお客様として Case を当番の {{site.data.keyword.Bluemix_notm}} サポート管理者にエスカレートすることで、さらに支援を要求できます。 

サポート Case をエスカレートするには、問題のサポート Case がオープンされている必要があります。 また、オープンしたサポート Case に、技術的な問題を詳しく記述したことも確認してください。
