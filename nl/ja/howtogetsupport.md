...
* [プレミアム・サポート](/docs/get-support/getstarttssup.html##premium-support)・アカウントの場合、ヘルプを利用するための電話番号が提供されます。
* アカウントが {{site.data.keyword.slportal}}で作成され、PaaS サービスと IaaS サービスの間でリンクされていて、かつ、[プレミアム・サポート](/docs/get-support/getstarttssup.html##premium-support)・アカウントである場合、チャット・セッションを開始することもできます。
...
有効な {{site.data.keyword.Bluemix_notm}} アカウントを使用している場合は、以下の手順を使用して、サポート・センターからサポート・チケットをオープンできます。
